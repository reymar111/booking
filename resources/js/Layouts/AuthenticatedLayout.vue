...
<template>
    <div class="antialiased bg-gray-300 dark:bg-gray-900">
        <nav class="bg-[#e5d6d6] border-b border-gray-200 px-4 h-[80px] flex items-center dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
  <div class="flex justify-between items-center w-full">
    ...
    <main class="p-4 md:ml-64 h-auto mt-20 pt-10">
