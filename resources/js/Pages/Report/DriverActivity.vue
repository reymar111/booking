                    ...
                    <table ref="printTable" class="min-w-full border border-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="px-4 py-2 text-left text-gray-700 border-b">License Number</th>
                                <th class="px-4 py-2 text-left text-gray-700 border-b">Contact Number</th>
...
export default {
    ...
    methods: {
        ...
        printReport() {
            ...
            const title = `<h1>Driver Activity Report</h1>`;
