...
<template>
    <AuthenticatedLayout>
        <Head title="Reports / Passenger Summary" />
            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-lg sm:rounded-lg">
                    <div class="p-6 text-gray-900 flex flex-col md:flex-row md:justify-between md:items-center space-y-4 md:space-y-0 ">
                        <h3 class="text-2xl font-bold ">Reports - Passenger Summary</h3>
                            ...
                            <div class="flex items-center space-x-2 w-full md:w-auto">
                                ...
                                <button @click="filterPassengerSummary" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center space-x-2">
...
export default {
    ...
    methods: {
        filterPassengerSummary() {
            this.$inertia.post('/reports/passenger_summary', {
